...
namespace Engine.Injectors.RCUT
{
    public class Injector: IInjector
    {
        ...
        public IntPtr Inject(Core targetProcess, string filePath)
        {
            ...
            var ntdllmod = ProcessCore.WinAPI.GetModuleHandleA("ntdll.dll");
            ...
            var rtlCreateUserThreadAddress = ProcessCore.WinAPI.GetProcAddress(ntdllmod, "RtlCreateUserThread");
